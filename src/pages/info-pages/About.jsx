...
import librarycontact from '../../assets/backgrounds/library-contact.jpg';
    ...
    <div className='default-page-wrapper'>
      <div className='relative'>
        ...
        <div className='w-full h-96 flex flex-col items-center justify-center absolute top-0 z-10 px-5 lg:px-0'>
            <h1 className='info-page-h1'>O nas</h1>
            <p className='info-page-h1-p'>Dowiedz się więcej o naszej firmie oraz jej celach.</p>
        </div>
      </div>
