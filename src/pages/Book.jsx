...
function Book() {
  return (
    ...
    <div className='grid grid-cols-[1fr_2fr_3fr] gap-20 h-96 w-full top-[2rem] absolute'>
      ...
      {/* <CarouselBook /> */}
      <div className='flex flex-col w-3/4 relative border-b-[1px] border-sunrise-300 dark:border-midnight-700'>
      <h1 className='text-4xl font-semibold my-3 cursor-default dark:text-white'>Harry Potter and Philosopher's Stone</h1>
          ...
          <p className='font-light my-2 cursor-default dark:text-white'>Okładka twarda</p>
