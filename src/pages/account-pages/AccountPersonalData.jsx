...
function AccountPersonalData() {
  ...
  return (
    <>
    <div className='flex flex-col px-5 py-5 bg-white rounded-md dark:bg-midnight-950'>
      <h1 className='text-xl mb-3 font-semibold'>Konto użytkownika</h1>
      <form>
    ...
    <div className='fixed flex justify-center items-center top-0 right-0 w-full h-full z-100 bg-black/50'>
        <div className='bg-white px-10 py-10 rounded-md w-auto h-auto flex flex-col items-center justify-center'>
          <h1 className='text-xl font-medium my-2'>Czy napewno chcesz usunąć konto?</h1>
          <p className='my-2'>Konto zostanie dezaktywowane na 30 dni, <br></br> a następnie zostanie permanentnie usunięte.</p>
