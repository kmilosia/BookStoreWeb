    ...
    <div className='default-page-wrapper'>
      <div className='default-page-container'>
        ...
        {elements && elements.map((item,index) => {
          return (
            <Link to={`/kategorie/${item.path}?id=${item.categoryID}`} key={index} className='flex flex-col justify-center items-center px-10 py-5 bg-white dark:bg-midnight-800 rounded-md shadow-md hover:bg-gray-100 dark:hover:bg-midnight-700'>
