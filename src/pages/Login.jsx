        ...
        <button onClick={() => navigate(-1)} className='absolute top-5 left-5 text-white flex items-center underline-hover'>
          ...
          <div className='flex flex-col items-center justify-center'>
            ...
            <div className="relative my-1">
              <input type="text" id='username-input' className="block px-2.5 pb-2.5 pt-4 w-full text-sm border-black/10 text-white bg-black/20 rounded-md appearance-none focus:outline-none focus:ring-0 focus:border-purple-500 peer" placeholder=" " />
            ...
            <div className="relative my-1">
              ...
              <input type={`${isHiddenPassword ? 'password' : 'text'}`} id='password-input' className="block border-black/10 pl-2.5 pr-10 pb-2.5 pt-4 w-full text-sm text-white bg-black/20 rounded-md appearance-none focus:outline-none focus:ring-0 focus:border-purple-500 peer" placeholder=" " />
            ...
            <button className='w-full bg-purple-600 text-white py-2 my-2 text-sm rounded-md font-semibold hover:bg-purple-700'>Zaloguj się</button>
            </form>
            <button className='text-xs text-purple-400 hover:text-purple-500 font-semibold my-2 w-full'>Zapomniałeś hasła?</button>
            <div className='flex flex-row justify-center my-1'>
              <p className='text-xs text-white'>Nie masz jeszcze konta?</p>
              <Link to='/rejestracja' className='text-xs text-purple-400 hover:text-purple-500 font-semibold mx-1'>Zarejestruj się</Link>
            </div>
          </div>
        </div>
