  ...
  return (
    <div className='default-page-wrapper'>
        <div className='default-page-container'>
            ...
            <div className={`flex flex-col bg-gray-100 dark:bg-midnight-950 lg:bg-transparent py-5 lg:py-0 px-5 lg:px-0 absolute z-[1000000] w-full lg:relative lg:top-auto right-0 lg:right-auto duration-500 ${isFilterOpen ? 'top-0 overflow-y-auto' : 'top-[-1000px]'}`}>
