...
export {default as RecoverPasswordFirstStep} from './pages/access-pages/recover-password-pages/RecoverPasswordFirstStep'
export {default as RecoverPasswordSecondStep} from './pages/access-pages/recover-password-pages/RecoverPasswordSecondStep'
export {default as RecoverPasswordThirdStep} from './pages/access-pages/recover-password-pages/RecoverPasswordThirdStep'

export {default as Register} from './pages/access-pages/register-pages/Register'
export {default as RegisterFirstStep} from './pages/access-pages/register-pages/RegisterFirstStep'
export {default as RegisterSecondStep} from './pages/access-pages/register-pages/RegisterSecondStep'
export {default as RegisterLastStep} from './pages/access-pages/register-pages/RegisterLastStep'
