...
export {default as OrderInformations} from './pages/OrderInformations'
...
export {default as FileReader} from './pages/FileReader'
...
export {default as CheckoutReview} from './pages/CheckoutReview'
...
export {default as DownloadBook} from './pages/mobile-redirect/DownloadBook'
export {default as DownloadInvoice} from './pages/mobile-redirect/DownloadInvoice'
export {default as DisplayFile} from './pages/mobile-redirect/DisplayFile'
