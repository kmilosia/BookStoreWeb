...
function AddReviewModal({setIsReviewed, bookItemId}) {
  ...
  return (
    ...
    <p className='text-2xl font-medium text-black dark:text-white'>Oceń książkę</p>
    ...
    <textarea rows={3} className='resize-none my-1 form-input focus:border-purple-400 text-black dark:text-white' onChange={handleInput} placeholder='Napisz swoją recenzję...'/>
